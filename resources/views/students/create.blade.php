...
<form method="post" action="/admin/students" class="mb-5" enctype="multipart/form-data" data-parsley-validate>
    @csrf
  <div class="mb-3">
    <label for="std_nis" class="form-label">Nis</label>
  ...
  <div class="mb-3">
    <label for="category" class="form-label">Nomor Telepon siswa</label>
    <select class="form-select" name="ctg_id" required data-parsley-inputs data-parsley-trigger="keyup">
        <option value="">Pilih Kategori</option>
        @foreach ($categories as $category)
            <option value="{{$category->ctg_id}}">{{ $category->ctg_name}}</option>
  ...
  <div class="mb-3">
    <label for="category" class="form-label">Nama orang tua/wali</label>
    <select class="form-select" name="ctg_id" required data-parsley-inputs data-parsley-trigger="keyup">
        <option value="">Pilih Kategori</option>
        @foreach ($categories as $category)
            <option value="{{$category->ctg_id}}">{{ $category->ctg_name}}</option>
  ...
  <div class="mb-3">
    <label for="category" class="form-label">Nomor telepon orang tua/wali</label>
    <select class="form-select" name="ctg_id" required data-parsley-inputs data-parsley-trigger="keyup">
        <option value="">Pilih Kategori</option>
        @foreach ($categories as $category)
            <option value="{{$category->ctg_id}}">{{ $category->ctg_name}}</option>
